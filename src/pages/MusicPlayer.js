...
const MusicPlayer = () => {
  return (
    <div className="flex flex-col items-center w-1/2 text-center my-12 text-white">
      ...
      <div className="flex flex-col items-center justify-center w-7/12">
        ...
        <div className="flex items-center justify-center w-full py-2 my-4">
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="w-14 h-12 text-gray-200 p-2 rounded-full hover:bg-gray-500"
          >
            <path
              fillRule="evenodd"
          ...
          <div className="flex items-center justify-center w-full gap-2">
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="w-10 h-10 text-gray-200 mx-4 p-2 rounded-full hover:bg-gray-500"
            >
            ...
            {true ? (
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="w-10 h-10 cursor-pointer text-gray-200 p-1 rounded-full hover:bg-gray-500 "
              >
                <path
                  fillRule="evenodd"
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="w-12 h-10 text-gray-200 p-2 rounded-full hover:bg-gray-500"
          >
